                        ...
                        <div className="col s12 m12">
                            <div className="card grey darken-2 card-panel hoverable">
                                ...
                                <div className="card-action">
                                    <button className="btn waves-effect waves-light green" id="izmeniSobuBtn" /*onClick={()=>{this.sobeClick(hotel.id)}}*/>Izmeni</button>
                                    <button className="btn waves-effect waves-light red" id="obrisiSobuBtn">Obrisi</button>
                                </div>
                            </div>
                        </div>
                    </div>
