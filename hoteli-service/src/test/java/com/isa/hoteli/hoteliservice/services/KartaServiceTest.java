...
public class KartaServiceTest
{
	...
	private KartaDTO karta1Dto = new KartaDTO(1l, 100, 5, false, 0, "a", null, LocalDateTime.now(), null, null);
	private KartaDTO karta2Dto = new KartaDTO(2l, 200, 1, true, 0, "b", null, LocalDateTime.now(), null, null);
